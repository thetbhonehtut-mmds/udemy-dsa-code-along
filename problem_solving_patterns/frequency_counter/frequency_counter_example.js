...
function same(array1, array2) {
  ...
  for (let i = 0; i < array1.length; i++) {
    ...
    array1FrequencyObject[currentElement]
      ? array1FrequencyObject[currentElement]++
      : (array1FrequencyObject[currentElement] = 1);
  }
  ...
  for (let i = 0; i < array2.length; i++) {
    ...
    array2FrequencyObject[currentElement]
      ? array2FrequencyObject[currentElement]++
      : (array2FrequencyObject[currentElement] = 1);
  }

  let result = true;
  Object.entries(array1FrequencyObject).forEach((element) => {
    let frequencyOfSquaredElement =
      array2FrequencyObject[Math.pow(parseInt(element[0]), 2)];
